...
func newPartitionCmd(c *config.Config) *cobra.Command {
	...
	cmdsConfig := &genericcli.CmdsConfig[any, any, *apiv2.Partition]{
		...
		Singular:        "partition",
		Plural:          "partitions",
		Description:     "read partitions which represent a failure domain of the metal cloud",
...
func (c *partition) Convert(r *apiv2.Partition) (string, any, any, error) {
	panic("unimplemented")
}

func (c *partition) Update(rq any) (*apiv2.Partition, error) {
	panic("unimplemented")
}
