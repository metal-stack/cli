...
func addNetwork(prefix string, n *apiv2.Network, wide bool) ([]string, error) {
	...
	if wide {
		return []string{id, description, name, networkType, project, partition, natType, prefixes, annotations}, nil
	} else {
		return []string{id, name, networkType, project, partition, natType, prefixes, shortPrefixUsage, shortIPUsage}, nil
	}
}
