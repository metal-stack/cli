## metalctlv2 admin partition delete

deletes the partition

```
metalctlv2 admin partition delete <id> [flags]
```
...
```
  ...
  -f, --file string             filename of the create or update request in yaml format, or - for stdin.
                                ...
                                $ vi partition.yaml
                                $ # either via stdin
                                $ cat partition.yaml | metalctlv2 partition delete <id> -f -
                                $ # or via file
                                $ metalctlv2 partition delete <id> -f partition.yaml
