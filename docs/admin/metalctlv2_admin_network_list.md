## metalctlv2 admin network list

list all networks

```
metalctlv2 admin network list [flags]
```
...
```
  ...
  -h, --help                           help for list
      ...
      --nat-type string                nat type of the network. [optional]
      --parent-network string          parent network to filter [optional]
