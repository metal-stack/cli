## metalctlv2 admin project update

updates the project

```
metalctlv2 admin project update [flags]
```
...
```
  ...
  -f, --file string             filename of the create or update request in yaml format, or - for stdin.
                                ...
                                $ vi project.yaml
                                $ # either via stdin
                                $ cat project.yaml | metalctlv2 project update -f -
                                $ # or via file
                                $ metalctlv2 project update -f project.yaml
