## metalctlv2 admin network delete

deletes the network

```
metalctlv2 admin network delete <id> [flags]
```
...
```
  ...
  -f, --file string             filename of the create or update request in yaml format, or - for stdin.
                                ...
                                $ vi network.yaml
                                $ # either via stdin
                                $ cat network.yaml | metalctlv2 network delete <id> -f -
                                $ # or via file
                                $ metalctlv2 network delete <id> -f network.yaml
