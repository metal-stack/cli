## metalctlv2 admin switch delete

deletes the switch

```
metalctlv2 admin switch delete <id> [flags]
```
...
```
  ...
  -f, --file string             filename of the create or update request in yaml format, or - for stdin.
                                ...
                                Example:
                                $ metalctlv2 switch describe switch-1 -o yaml > switch.yaml
                                $ vi switch.yaml
                                $ # either via stdin
                                $ cat switch.yaml | metalctlv2 switch delete <id> -f -
                                $ # or via file
                                $ metalctlv2 switch delete <id> -f switch.yaml
