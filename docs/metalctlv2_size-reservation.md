## metalctlv2 size-reservation

manage size-reservation entities

### Synopsis

read size reservations which allow to reserve machine capacity

### Options

```
  -h, --help   help for size-reservation
```
...
* [metalctlv2 size-reservation describe](metalctlv2_size-reservation_describe.md)	 - describes the size-reservation
* [metalctlv2 size-reservation list](metalctlv2_size-reservation_list.md)	 - list all size-reservations
