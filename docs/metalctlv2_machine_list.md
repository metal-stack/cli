...
```
  -h, --help               help for list
      --partition string   partition to filter for
  -p, --project string     project to list machines for
      --size string        size to filter for
      --sort-by strings    sort by (comma separated) column(s), sort direction can be changed by appending :asc or :desc behind the column identifier. possible values: id|liveliness|partition
```
